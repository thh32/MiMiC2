...
# Add the organisms
bac1 <- BacArena::Bac(C1,type=args[15])
bac2 <- BacArena::Bac(C2,type=args[16])
bac3 <- BacArena::Bac(C3,type=args[17])
bac4 <- BacArena::Bac(C4,type=args[18])
bac5 <- BacArena::Bac(C5,type=args[19])
bac6 <- BacArena::Bac(C6,type=args[20])
bac7 <- BacArena::Bac(C7,type=args[21])
bac8 <- BacArena::Bac(C8,type=args[22])
