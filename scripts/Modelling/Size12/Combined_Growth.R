...
# Add the organisms
bac1 <- BacArena::Bac(C1,type=args[19])
bac2 <- BacArena::Bac(C2,type=args[20])
bac3 <- BacArena::Bac(C3,type=args[21])
bac4 <- BacArena::Bac(C4,type=args[22])
bac5 <- BacArena::Bac(C5,type=args[23])
bac6 <- BacArena::Bac(C6,type=args[24])
bac7 <- BacArena::Bac(C7,type=args[25])
bac8 <- BacArena::Bac(C8,type=args[26])
bac9 <- BacArena::Bac(C9,type=args[27])
bac10 <- BacArena::Bac(C10,type=args[28])
bac11 <- BacArena::Bac(C11,type=args[29])
bac12 <- BacArena::Bac(C12,type=args[30])
