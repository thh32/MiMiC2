...
# Add the organisms
bac1 <- BacArena::Bac(C1,type=args[21])
bac2 <- BacArena::Bac(C2,type=args[22])
bac3 <- BacArena::Bac(C3,type=args[23])
bac4 <- BacArena::Bac(C4,type=args[24])
bac5 <- BacArena::Bac(C5,type=args[25])
bac6 <- BacArena::Bac(C6,type=args[26])
bac7 <- BacArena::Bac(C7,type=args[27])
bac8 <- BacArena::Bac(C8,type=args[28])
bac9 <- BacArena::Bac(C9,type=args[29])
bac10 <- BacArena::Bac(C10,type=args[30])
bac11 <- BacArena::Bac(C11,type=args[31])
bac12 <- BacArena::Bac(C12,type=args[32])
bac13 <- BacArena::Bac(C13,type=args[33])
bac14 <- BacArena::Bac(C14,type=args[34])
...
arena <- BacArena::addOrg(arena, bac12, amount=10)
arena <- BacArena::addOrg(arena, bac13, amount=10)
arena <- BacArena::addOrg(arena, bac14, amount=10)
